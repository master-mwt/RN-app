...
export default class SeasonPage extends Component {
    ...
    componentDidMount() {
        API.getTvShowSeason(this.props.route.params.item.tv_show_id, this.props.route.params.item.season_number).then(res => {
            this.setState({
                tv_season: res,
            });
                ...
                {this.state.tv_season && (
                    <View style={styles.container}>
                        <ScrollView>
                            ...
                            <View style={styles.box}>
                                <Text style={styles.title}>{this.state.tv_season.season_number}</Text>
                            </View>
                            <View style={styles.box}>
                                <Text style={styles.title}>{this.state.tv_season.air_date}</Text>
                            </View>
                            <View style={styles.box}>
